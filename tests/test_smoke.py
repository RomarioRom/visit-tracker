...
from visit_tracker.cli import main
from visit_tracker.models import Note, ProjectState, Task
from visit_tracker.cli import demo_state
from visit_tracker.storage import load_state, save_state
from visit_tracker.models import generate_short_id
from visit_tracker.validation import normalize_tags, require_text, validate_task_status
from visit_tracker.services import (
    create_note,
    list_notes,
    get_note,
    update_note,
